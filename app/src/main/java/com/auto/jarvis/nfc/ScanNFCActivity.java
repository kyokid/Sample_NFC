...
//    https://code.tutsplus.com/tutorials/reading-nfc-tags-with-android--mobile-17278
    ...
    private void configureNFC() {
        ...
        if (!mNfcAdapter.isEnabled()) {
            ...
            tvAdapter.setText("NFC is disabled.");
        } else {
            tvAdapter.setText("NFC is available");
        }
    ...
    public static Intent newInstance(Context context){
        Intent intent = new Intent(context, ScanNFCActivity.class);
    ...
    private class NdefReaderTask extends AsyncTask<Tag, Void, String> {
        ...
        protected void onPostExecute(String result) {
            if (result != null) {
                tvResult.setText("Read content: " + result);
            }
        }
    }
}
